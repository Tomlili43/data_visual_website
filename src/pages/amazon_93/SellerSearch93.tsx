...
import { getSellerInfo93 } from '@/services/ant-design-pro/product';
...
const SellerSearch93: React.FC = () => {
  ...
  const searchProducts = async () => {
    try {
      const response = await getSellerInfo93(inputValue);
      // Table 1: data_seller
      // Below lines move the productId field to the start
      const keyToMove1 = 'sellerId';
      const entries1 = Object.entries(response["data"]["data_seller"]);
      ...
      const data_product = response["data"]["data_product"]
